    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto pt-12">
        ...
        {!isScrolledToBottom && (
          <div className="text-center mb-8">
            <p className="text-gray-500">
              Faites défiler pour lire l'intégralité du document
            </p>
          </div>
        )}
        ...
        <div className="text-center">
          <button
            onClick={onAgree}
            className={`bg-black text-white py-4 px-12 rounded-lg font-medium text-lg transition-opacity flex items-center mx-auto ${
              !isScrolledToBottom ? 'opacity-40 cursor-not-allowed' : 'hover:opacity-90'
            }`}
